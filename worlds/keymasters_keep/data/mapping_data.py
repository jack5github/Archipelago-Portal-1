...
label_mapping: Dict[Any, str] = {
    ...
    KeymastersKeepGoals.AREA_DOMINATION: "Area Domination",
...
region_to_completion_location: Dict[KeymastersKeepRegions, KeymastersKeepLocations] = {
    ...
    KeymastersKeepRegions.THE_CLANDESTINE_PASSAGE: KeymastersKeepLocations.THE_CLANDESTINE_PASSAGE_COMPLETE,
    KeymastersKeepRegions.THE_CLOAKED_ENTRANCE: KeymastersKeepLocations.THE_CLOAKED_ENTRANCE_COMPLETE,
    KeymastersKeepRegions.THE_CLOAKED_THRESHOLD: KeymastersKeepLocations.THE_CLOAKED_THRESHOLD_COMPLETE,
    KeymastersKeepRegions.THE_CLOAKED_VAULT: KeymastersKeepLocations.THE_CLOAKED_VAULT_COMPLETE,
    KeymastersKeepRegions.THE_CONCEALED_THRESHOLD: KeymastersKeepLocations.THE_CONCEALED_THRESHOLD_COMPLETE,
    KeymastersKeepRegions.THE_CONCEALED_VAULT: KeymastersKeepLocations.THE_CONCEALED_VAULT_COMPLETE,
    KeymastersKeepRegions.THE_CRYPTIC_CHAMBER: KeymastersKeepLocations.THE_CRYPTIC_CHAMBER_COMPLETE,
    KeymastersKeepRegions.THE_CRYPTIC_GATEWAY: KeymastersKeepLocations.THE_CRYPTIC_GATEWAY_COMPLETE,
    KeymastersKeepRegions.THE_CRYPTIC_VAULT: KeymastersKeepLocations.THE_CRYPTIC_VAULT_COMPLETE,
    KeymastersKeepRegions.THE_DISGUISED_GATEWAY: KeymastersKeepLocations.THE_DISGUISED_GATEWAY_COMPLETE,
    KeymastersKeepRegions.THE_ECHOING_PASSAGE: KeymastersKeepLocations.THE_ECHOING_PASSAGE_COMPLETE,
    KeymastersKeepRegions.THE_ELUSIVE_DOOR: KeymastersKeepLocations.THE_ELUSIVE_DOOR_COMPLETE,
    KeymastersKeepRegions.THE_ENCHANTED_GATEWAY: KeymastersKeepLocations.THE_ENCHANTED_GATEWAY_COMPLETE,
    KeymastersKeepRegions.THE_ENCHANTED_PASSAGE: KeymastersKeepLocations.THE_ENCHANTED_PASSAGE_COMPLETE,
    KeymastersKeepRegions.THE_ENIGMATIC_PORTAL: KeymastersKeepLocations.THE_ENIGMATIC_PORTAL_COMPLETE,
    KeymastersKeepRegions.THE_ENIGMATIC_THRESHOLD: KeymastersKeepLocations.THE_ENIGMATIC_THRESHOLD_COMPLETE,
    KeymastersKeepRegions.THE_FADED_GATEWAY: KeymastersKeepLocations.THE_FADED_GATEWAY_COMPLETE,
    KeymastersKeepRegions.THE_FAINT_DOORWAY: KeymastersKeepLocations.THE_FAINT_DOORWAY_COMPLETE,
    KeymastersKeepRegions.THE_FAINT_PATH: KeymastersKeepLocations.THE_FAINT_PATH_COMPLETE,
    KeymastersKeepRegions.THE_FAINT_THRESHOLD: KeymastersKeepLocations.THE_FAINT_THRESHOLD_COMPLETE,
    KeymastersKeepRegions.THE_FORBIDDEN_ENTRANCE: KeymastersKeepLocations.THE_FORBIDDEN_ENTRANCE_COMPLETE,
    KeymastersKeepRegions.THE_FORGOTTEN_DOOR: KeymastersKeepLocations.THE_FORGOTTEN_DOOR_COMPLETE,
    KeymastersKeepRegions.THE_FORGOTTEN_GATEWAY: KeymastersKeepLocations.THE_FORGOTTEN_GATEWAY_COMPLETE,
    KeymastersKeepRegions.THE_FORGOTTEN_PORTAL: KeymastersKeepLocations.THE_FORGOTTEN_PORTAL_COMPLETE,
    KeymastersKeepRegions.THE_FORGOTTEN_THRESHOLD: KeymastersKeepLocations.THE_FORGOTTEN_THRESHOLD_COMPLETE,
    KeymastersKeepRegions.THE_GHOSTED_PASSAGEWAY: KeymastersKeepLocations.THE_GHOSTED_PASSAGEWAY_COMPLETE,
    KeymastersKeepRegions.THE_GHOSTLY_PASSAGE: KeymastersKeepLocations.THE_GHOSTLY_PASSAGE_COMPLETE,
    KeymastersKeepRegions.THE_HIDDEN_ARCHWAY: KeymastersKeepLocations.THE_HIDDEN_ARCHWAY_COMPLETE,
    KeymastersKeepRegions.THE_HIDDEN_CHAMBER: KeymastersKeepLocations.THE_HIDDEN_CHAMBER_COMPLETE,
    KeymastersKeepRegions.THE_HIDDEN_DOORWAY: KeymastersKeepLocations.THE_HIDDEN_DOORWAY_COMPLETE,
    KeymastersKeepRegions.THE_HIDDEN_ENTRANCE: KeymastersKeepLocations.THE_HIDDEN_ENTRANCE_COMPLETE,
    KeymastersKeepRegions.THE_HIDDEN_KEYHOLE: KeymastersKeepLocations.THE_HIDDEN_KEYHOLE_COMPLETE,
    KeymastersKeepRegions.THE_HIDDEN_PASSAGEWAY: KeymastersKeepLocations.THE_HIDDEN_PASSAGEWAY_COMPLETE,
    KeymastersKeepRegions.THE_HIDDEN_PATH: KeymastersKeepLocations.THE_HIDDEN_PATH_COMPLETE,
    KeymastersKeepRegions.THE_HIDDEN_REACH: KeymastersKeepLocations.THE_HIDDEN_REACH_COMPLETE,
    KeymastersKeepRegions.THE_HIDDEN_VAULT: KeymastersKeepLocations.THE_HIDDEN_VAULT_COMPLETE,
    KeymastersKeepRegions.THE_INCONSPICUOUS_DOOR: KeymastersKeepLocations.THE_INCONSPICUOUS_DOOR_COMPLETE,
    KeymastersKeepRegions.THE_INVISIBLE_DOORWAY: KeymastersKeepLocations.THE_INVISIBLE_DOORWAY_COMPLETE,
    KeymastersKeepRegions.THE_LOCKED_DOORWAY: KeymastersKeepLocations.THE_LOCKED_DOORWAY_COMPLETE,
    KeymastersKeepRegions.THE_LOCKED_GATEWAY: KeymastersKeepLocations.THE_LOCKED_GATEWAY_COMPLETE,
    KeymastersKeepRegions.THE_LOST_ARCHWAY: KeymastersKeepLocations.THE_LOST_ARCHWAY_COMPLETE,
    KeymastersKeepRegions.THE_LOST_PORTAL: KeymastersKeepLocations.THE_LOST_PORTAL_COMPLETE,
    KeymastersKeepRegions.THE_LOST_THRESHOLD: KeymastersKeepLocations.THE_LOST_THRESHOLD_COMPLETE,
    KeymastersKeepRegions.THE_MYSTERIOUS_ARCH: KeymastersKeepLocations.THE_MYSTERIOUS_ARCH_COMPLETE,
    KeymastersKeepRegions.THE_MYSTERIOUS_DOORWAY: KeymastersKeepLocations.THE_MYSTERIOUS_DOORWAY_COMPLETE,
    KeymastersKeepRegions.THE_MYSTERIOUS_PASSAGE: KeymastersKeepLocations.THE_MYSTERIOUS_PASSAGE_COMPLETE,
    KeymastersKeepRegions.THE_MYSTERIOUS_VAULT: KeymastersKeepLocations.THE_MYSTERIOUS_VAULT_COMPLETE,
    KeymastersKeepRegions.THE_MYSTICAL_PASSAGE: KeymastersKeepLocations.THE_MYSTICAL_PASSAGE_COMPLETE,
    KeymastersKeepRegions.THE_OBSCURED_ARCH: KeymastersKeepLocations.THE_OBSCURED_ARCH_COMPLETE,
    KeymastersKeepRegions.THE_OBSCURED_DOORWAY: KeymastersKeepLocations.THE_OBSCURED_DOORWAY_COMPLETE,
    KeymastersKeepRegions.THE_OBSCURED_PORTAL: KeymastersKeepLocations.THE_OBSCURED_PORTAL_COMPLETE,
    KeymastersKeepRegions.THE_OBSCURED_VAULT: KeymastersKeepLocations.THE_OBSCURED_VAULT_COMPLETE,
    KeymastersKeepRegions.THE_OBSCURE_PASSAGE: KeymastersKeepLocations.THE_OBSCURE_PASSAGE_COMPLETE,
    KeymastersKeepRegions.THE_PHANTOM_PASSAGE: KeymastersKeepLocations.THE_PHANTOM_PASSAGE_COMPLETE,
    KeymastersKeepRegions.THE_PHANTOM_VAULT: KeymastersKeepLocations.THE_PHANTOM_VAULT_COMPLETE,
    KeymastersKeepRegions.THE_QUIET_ARCHWAY: KeymastersKeepLocations.THE_QUIET_ARCHWAY_COMPLETE,
    KeymastersKeepRegions.THE_QUIET_THRESHOLD: KeymastersKeepLocations.THE_QUIET_THRESHOLD_COMPLETE,
    KeymastersKeepRegions.THE_SEALED_CHAMBER: KeymastersKeepLocations.THE_SEALED_CHAMBER_COMPLETE,
    KeymastersKeepRegions.THE_SEALED_GATEWAY: KeymastersKeepLocations.THE_SEALED_GATEWAY_COMPLETE,
    KeymastersKeepRegions.THE_SEALED_THRESHOLD: KeymastersKeepLocations.THE_SEALED_THRESHOLD_COMPLETE,
    KeymastersKeepRegions.THE_SECRETED_DOOR: KeymastersKeepLocations.THE_SECRETED_DOOR_COMPLETE,
    KeymastersKeepRegions.THE_SECRETIVE_DOOR: KeymastersKeepLocations.THE_SECRETIVE_DOOR_COMPLETE,
    KeymastersKeepRegions.THE_SECRET_ARCHWAY: KeymastersKeepLocations.THE_SECRET_ARCHWAY_COMPLETE,
    KeymastersKeepRegions.THE_SECRET_PASSAGEWAY: KeymastersKeepLocations.THE_SECRET_PASSAGEWAY_COMPLETE,
    KeymastersKeepRegions.THE_SECRET_THRESHOLD: KeymastersKeepLocations.THE_SECRET_THRESHOLD_COMPLETE,
    KeymastersKeepRegions.THE_SECRET_VAULT: KeymastersKeepLocations.THE_SECRET_VAULT_COMPLETE,
    KeymastersKeepRegions.THE_SHADOWED_PORTAL: KeymastersKeepLocations.THE_SHADOWED_PORTAL_COMPLETE,
    KeymastersKeepRegions.THE_SHADOWED_THRESHOLD: KeymastersKeepLocations.THE_SHADOWED_THRESHOLD_COMPLETE,
    KeymastersKeepRegions.THE_SHADOWY_PASSAGE: KeymastersKeepLocations.THE_SHADOWY_PASSAGE_COMPLETE,
    KeymastersKeepRegions.THE_SHIMMERING_PASSAGE: KeymastersKeepLocations.THE_SHIMMERING_PASSAGE_COMPLETE,
    KeymastersKeepRegions.THE_SHROUDED_GATEWAY: KeymastersKeepLocations.THE_SHROUDED_GATEWAY_COMPLETE,
    KeymastersKeepRegions.THE_SHROUDED_PORTAL: KeymastersKeepLocations.THE_SHROUDED_PORTAL_COMPLETE,
    KeymastersKeepRegions.THE_SILENT_ARCHWAY: KeymastersKeepLocations.THE_SILENT_ARCHWAY_COMPLETE,
    KeymastersKeepRegions.THE_SILENT_PASSAGE: KeymastersKeepLocations.THE_SILENT_PASSAGE_COMPLETE,
    KeymastersKeepRegions.THE_SILENT_THRESHOLD: KeymastersKeepLocations.THE_SILENT_THRESHOLD_COMPLETE,
    KeymastersKeepRegions.THE_SILENT_VAULT: KeymastersKeepLocations.THE_SILENT_VAULT_COMPLETE,
    KeymastersKeepRegions.THE_UNFATHOMABLE_DOOR: KeymastersKeepLocations.THE_UNFATHOMABLE_DOOR_COMPLETE,
    KeymastersKeepRegions.THE_UNKNOWN_ARCH: KeymastersKeepLocations.THE_UNKNOWN_ARCH_COMPLETE,
    KeymastersKeepRegions.THE_UNKNOWN_GATEWAY: KeymastersKeepLocations.THE_UNKNOWN_GATEWAY_COMPLETE,
    KeymastersKeepRegions.THE_UNMARKED_PASSAGE: KeymastersKeepLocations.THE_UNMARKED_PASSAGE_COMPLETE,
    KeymastersKeepRegions.THE_UNMARKED_VAULT: KeymastersKeepLocations.THE_UNMARKED_VAULT_COMPLETE,
    KeymastersKeepRegions.THE_UNRAVELED_DOOR: KeymastersKeepLocations.THE_UNRAVELED_DOOR_COMPLETE,
    KeymastersKeepRegions.THE_UNSEEN_ARCHWAY: KeymastersKeepLocations.THE_UNSEEN_ARCHWAY_COMPLETE,
    KeymastersKeepRegions.THE_UNSEEN_DOOR: KeymastersKeepLocations.THE_UNSEEN_DOOR_COMPLETE,
    KeymastersKeepRegions.THE_UNSEEN_PASSAGE: KeymastersKeepLocations.THE_UNSEEN_PASSAGE_COMPLETE,
    KeymastersKeepRegions.THE_UNSEEN_PORTAL: KeymastersKeepLocations.THE_UNSEEN_PORTAL_COMPLETE,
    KeymastersKeepRegions.THE_UNSPOKEN_GATE: KeymastersKeepLocations.THE_UNSPOKEN_GATE_COMPLETE,
    KeymastersKeepRegions.THE_UNTOLD_GATEWAY: KeymastersKeepLocations.THE_UNTOLD_GATEWAY_COMPLETE,
    KeymastersKeepRegions.THE_UNTRACEABLE_PATH: KeymastersKeepLocations.THE_UNTRACEABLE_PATH_COMPLETE,
    KeymastersKeepRegions.THE_VANISHING_ARCHWAY: KeymastersKeepLocations.THE_VANISHING_ARCHWAY_COMPLETE,
    KeymastersKeepRegions.THE_VANISHING_DOOR: KeymastersKeepLocations.THE_VANISHING_DOOR_COMPLETE,
    KeymastersKeepRegions.THE_VAULT_OF_WHISPERS: KeymastersKeepLocations.THE_VAULT_OF_WHISPERS_COMPLETE,
    KeymastersKeepRegions.THE_VEILED_PASSAGE: KeymastersKeepLocations.THE_VEILED_PASSAGE_COMPLETE,
    KeymastersKeepRegions.THE_VEILED_PATH: KeymastersKeepLocations.THE_VEILED_PATH_COMPLETE,
    KeymastersKeepRegions.THE_WHISPERED_PORTAL: KeymastersKeepLocations.THE_WHISPERED_PORTAL_COMPLETE,
    KeymastersKeepRegions.THE_WHISPERED_THRESHOLD: KeymastersKeepLocations.THE_WHISPERED_THRESHOLD_COMPLETE,
